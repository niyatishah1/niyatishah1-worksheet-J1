...
Private declaration for variable and functions acheives encapsulation_____
...
```
```
Output: There will be an error ___
```
...
```
Options 1 and 2 are both valid implementations. Option 1___
